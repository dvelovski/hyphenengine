...
import org.cstr24.hyphengl.interop.source.SourceMath;
...
import static org.cstr24.hyphengl.interop.source.studiomdl.structs.mstudioautolayer_t.*;
import static org.cstr24.hyphengl.interop.source.studiomdl.structs.mstudioautolayer_t.STUDIO_AL_NOBLEND;
import static org.cstr24.hyphengl.interop.source.studiomdl.structs.mstudioseqdesc_t.STUDIO_LOCAL;
...
public class StudioModelSequenceInstance extends AnimationInstance {
    ...
    public void computeBone(int index, int boneMask){
        ...
        if (owner.getEntity().hasComponent(BoneMergeComponent.TYPE)){
            var myName = boneDef.boneName;

            BoneMergeComponent component = (BoneMergeComponent) owner.getEntity().getComponent(BoneMergeComponent.TYPE);
