...
public abstract class HyMesh {
    ...
    public abstract HyMesh updateVertexData(HyBaseBuffer<?> data, int _vtxCount);
    public abstract HyMesh updateElementBuffer(HyBaseBuffer<?> ebo, int _idxCount);
    ...
    public static HyMesh create(){
        return Engine.getBackend().getMeshFactory().createMesh();
    }
}
