package org.cstr24.hyphenengine.interop.source;

import org.cstr24.hyphenengine.assets.AssetCache;
...
import org.cstr24.hyphenengine.interop.source.materials.SourceShaders;
import org.cstr24.hyphenengine.interop.source.studiomdl.StudioModelLoader;
import org.cstr24.hyphenengine.interop.source.vpk.VPKFileSystem;
import org.cstr24.hyphenengine.interop.source.vtf.VTFLoader;
...
public class SourceInterop {
    ...
    * Using a ByteBuffer wrapped then to a byte array would be incredibly ugly */
    ...
    public static void registerLoaders() {
        ...
        AssetCache.get().registerCacheProvider(SourceAssetTypes.VTF, new HyAssetTypeCache<>());
        AssetCache.get().registerCacheProvider(SourceAssetTypes.MDL, new HyAssetTypeCache<>());
    }
